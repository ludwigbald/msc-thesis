...
Grid-scale storage in Europe is mainly comprised of hydropower, which has been installed where mountainous geography allows, and capacity has reached its natural limit.\todo{cite}
...
In this thesis, my goal is to test Uncertainty-Aware Deep Q-Networks \todo{cite algorithm} on CityLearn. UA-DQN is an uncertainty-aware adaptation of Deep Q-Learning\todo{cite DQN}.
