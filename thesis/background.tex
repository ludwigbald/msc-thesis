...
\todo{Maybe: Mention a few RL applications that can be used as examples}
...
\todo[inline]{\cite{cruz2018ActionSelectionMethods} compare different action selection strategies, some of which dynamically adapt. cite one of them}
