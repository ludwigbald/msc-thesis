...
1. Introduce and explain UA-DQN
    - Significance and motivation:
        - With energy, you need to make risk-aware decisions, and exploration is expensive.
        - UA-DQN has very good performance in original paper (cite), beating DQN by exploring better. How?
    - Idea:
        - Learn distributions instead of only mean Q value.
        - Thompson sampling from these distributions.
        - Detangle epistemic and aleatoric uncertainty. How?
        - 
...
2. DQN variants
    ...
    - Boltzmann exploration (is the fancy name for Softmax)
